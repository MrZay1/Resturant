...
| Google in your own name or domain | Never "use, incorporate, or combine any of our trademarks (names or logos) into your brand name, product name, business name, trade name, website domain, or slogan." Tablenote and tablenote.co are clear. | https://about.google/brand-resource-center/guidance/ |
...
The card uses no Google logo and no stars. Front: the restaurant's name or logo, "Tap to review us on Google," and the subline "Hold your phone here." Back, as built in `site/components/card/CardFace.tsx` and `site/components/card/cardSpec.ts`: the restaurant name, a three-line "How to leave a review" instruction, "No tap? Scan the code or visit:" with the short link `tblnt.co/r/<slug>` in text, the QR code for the same `https://tblnt.co/r/<slug>?s=card` link, and the `backNote` thank-you line ("Thank you for dining with us. Your review helps our small team more than you know."). This is plain-text informational use and needs no permission (https://about.google/brand-resource-center/guidance/).
...
- [ ] A support email that is read daily (hello@tablenote.co is the placeholder) and, ideally, a phone number, since Stripe's checklist asks for contact "besides contact forms."
